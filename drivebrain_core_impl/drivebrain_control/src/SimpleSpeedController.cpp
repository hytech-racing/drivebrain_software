...
<<<<<<< HEAD:drivebrain_core_impl/drivebrain_control/src/SimpleController.cpp
...
>>>>>>> origin/TCMUX:drivebrain_core_impl/drivebrain_control/src/SimpleSpeedController.cpp
    return true;
}
