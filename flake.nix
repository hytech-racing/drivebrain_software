{
  ...
  inputs = {
    ...
    db-core-src = {
      url = "github:hytech-racing/drivebrain_core/456fb8eec9143d2bb10d26369737e000cae2d63d";
      flake = false;
    };

    db-simulink-gen-src = {
      url = "https://github.com/hytech-racing/drivebrain_simulink_models/releases/download/rel16/gen_rel.tar.gz";
      flake = false;
    };
  };
        ...
        perSystem = { config, pkgs, system, ... }:

          {
            ...
            devShells.default = pkgs.mkShell rec {
              ...
              packages = [ pkgs.mcap-cli pkgs.valgrind pkgs.grpcui pkgs.python311Packages.cantools pkgs.python311Packages.tkinter ];
              inputsFrom = [
